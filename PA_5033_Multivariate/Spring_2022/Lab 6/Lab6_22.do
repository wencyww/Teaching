...
set more off
cap log close
cd "O:\wang6054\PA 5033 Spring 2022\Lab 6"
use AgeGrp4_20data.dta
log using Lab6_log, text replace
...
*Difference between percent and percentage point: https://thewritingbusiness.com/the-difference-between-percentages-and-percentage-points/
...
* How do we interpret logit output?
	...
	* Average Marginal Effect
		...
		outreg2 using Lab6_regressions.doc, append ctitle(Logit)
...
* Calculate Average Marginal Effect
	...
	outreg2 using Lab6_regressions.doc, append ctitle(Dummy)
...
/* Perhaps we think there are some simultaneity problems with age and performance. If so, we can create a cleaned performance instrumental variable to account for this. We will use the residuals from the model: perf = f(age) as our I.V. This works because we can think of the residuals as the part of performance that isn't accounted for by age -- it's the part that isn't explained just by getting older in our dataset. Below are the steps to get this and use it in 2SLS*/
