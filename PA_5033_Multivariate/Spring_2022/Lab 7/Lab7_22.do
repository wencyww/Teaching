********************************************************************************
* Lab 7 --> Self-Selection Bias & Panel Data
...
set more off
cap log close
cd "O:\wang6054\PA 5033 Spring 2022\Lab 7"
log using Lab7, text replace
...
use 16.4-Panel.dta
	...
	*Random Effect (within and between average effects)
	xtreg Consumption Tax, re
	
	*Fxied Effect (within effects)
