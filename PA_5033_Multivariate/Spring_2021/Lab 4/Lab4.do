...
set more off
cap log close
cd "O:\wang6054\PA5033_Spring2021\Lab 4"
use PRtime_data.dta
log using Lab4, text replace
...
* Forecast Model 1: prepop = 0.507 + 0.0000119(prgnp) - 0.442(kaitz)
